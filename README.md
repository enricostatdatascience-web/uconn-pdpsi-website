...
- **Interactive roster** — live search across all 130 brothers by name, line name, or number,
...
- The home page shows **130 brothers** (counted live from `data.js`). The old Wix site's
